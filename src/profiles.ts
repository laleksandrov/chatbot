...
export const assistantProfilePolicies: Record<AssistantProfile, AssistantProfilePolicy> = {
  ...
  registered_customer: {
    ...
    instructions: [
      ...
      "Когато получиш registrationProgress, съобразявай разговора с текущата регистрационна стъпка и наличните запазени данни. Променяй регистрационни данни само чрез изрично разрешеното структурирано поле за съответната стъпка.",
    ].join(" "),
  },
};
