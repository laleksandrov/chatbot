...
Автоматичната QA проверка изисква очаквания брой страници и поне 20 OCR символа на всяка страница. Действително празни страници могат да бъдат разрешени изрично с `--allow-blank-pages`, но само след визуална проверка. След това човек проверява номера, заглавието, таблиците, датите, процентите и поне една представителна страница от началото, средата и края.
